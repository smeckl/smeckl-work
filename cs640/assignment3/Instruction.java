...
class Instruction extends Line
{
	...
	public Hashtable<String, String> mapRegToValue = new Hashtable<String, String>();
	...
	public boolean isOperation()
	{
		...
		if(0 == getInstruction().compareTo("li")
			|| 0 == getInstruction().compareTo("lw")
			|| 0 == getInstruction().compareTo("sw")
			|| 0 == getInstruction().compareTo("neg")
			|| 0 == getInstruction().compareTo("move")
			|| getIsJump())
			bRet = false;
	...
	public Hashtable<String, String> getMapRegToValue()
	{
		return mapRegToValue;
	}

	public void setMapRegToValue(Hashtable<String, String> mapRegToValue)
	{
		this.mapRegToValue = mapRegToValue;
	}
